...
static const struct mtk_composite topckgen_muxes[] = {
	...
	MUX_FLAGS(CLK_TOP_AXI_SEL, "axi_sel", axi_sel_parents, CLK_CFG_0, 5, 3,
		  CLK_IS_CRITICAL),
	MUX(CLK_TOP_MFG_MUX_SEL, "mfg_mux_sel", mfg_mux_parents, CLK_CFG_0, 8,
	    3),
	...
	MUX(CLK_TOP_SPINFI_PRE_SEL, "spinfi_pre_sel", spinfi_pre_sel_parents,
	    CLK_CFG_0, 30, 1),
	MUX(CLK_TOP_MFG_SEL, "mfg_sel", mfg_gf_parents, CLK_CFG_0, 31, 1),
};
...
static const struct mtk_gate top_clks[] = {
	...
	GATE_TOP0(CLK_TOP_MIPI_26M_DBG, "mipi_26m_dbg", "clk26m", 4),
	GATE_TOP0(CLK_TOP_SC_26M, "sc_26m", "clk26m", 6),
	GATE_TOP0(CLK_TOP_SC_MEM, "sc_mem", "clk26m", 7), // unk parent
	...
	GATE_TOP0(CLK_TOP_MFG_PRE_491M, "mfg_pre_491m", "mpll_d3", 20), // unk parent, but i tend to think it's mainpll/3
	GATE_TOP0(CLK_TOP_MFG_PRE_500M, "mfg_pre_500m", "whpll", 21),
	GATE_TOP0(CLK_TOP_ARMDCM, "armdcm", "clk26m", 31), // unk parent
