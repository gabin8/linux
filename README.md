...
| audio (playback + headphone jack)    | 🔴 TBD                                          | 🔴 TBD                      | 🔴 TBD                        | 🟢 OK: AFE + mt6323 codec, auto-routes spk<->HP |
...
| component          | driver                    | status  | note                                             |
|--------------------|---------------------------|---------|--------------------------------------------------|
| AFE (DL1 playback) | mediatek,mt6572-audio     | 🟢 OK   | DL1 front-end -> on-chip SRAM, HW-IRQ driven     |
